...
import CUSTpage from '../Customerpage/custhomepage';
...
const Custregister = () => {
    ...
    const [user, setUser] = useState({
        name: "", email: "", phone: "", latitude: "", longitude: "", password: "", cpassword: "", type: "customer"
    });
    ...
    return (
        <div>
            {authenticated && <CUSTpage loginUserData={loginUserData} />}
            {!authenticated && 
